...
void setMotor(Motor motor[], float throttle,int whichMotor){
  ...
  SoftPWMServoPWMWrite(motor[whichMotor].pin,floatMap(throttle,0,100,89,179));
  //motor[whichMotor].write(floatMap(throttle,0,100,20,150));
  //motor[whichMotor].writeMicroseconds(floatMap(floatMap(throttle,0,100,89,179),0,180,544,2400));
  //Serial.println("VAlue sent");
  //Serial.println(motor[whichMotor].pin);
}
